	...
	microAjax(url, function (res) {
	    res.split(String.fromCharCode(10)).forEach(
            function (entry) {
		        ...
		        else if(fields[2] == "style.bgcolor") {
                    document.getElementById(fields[0]).style.backgroundColor = fields[1];
		        }
		        else if(fields[2] == "style.color") {
                    document.getElementById(fields[0]).style.color = fields[1];
		        }
		        else if(fields[2] == "style.bordercolor") {
                    document.getElementById(fields[0]).style.borderColor = fields[1];
		        }
